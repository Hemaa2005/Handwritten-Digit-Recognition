...
🔍 Key Features:
* CNN model trained on grayscale MNIST digits
* Interactive GUI for real-time digit drawing and prediction
* Data augmentation for better generalization
* Works entirely on grayscale input (no color required)
